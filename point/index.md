![Точка сборки-3D](assets/header_point.png)
...
![Трехмерные интерактивные стерео-слайды](assets/3d_modes.png)
...
- [Инь (STL)](/p3/stl/dao_01.stl)
- [Янь (STL)](/p3/stl/dao_01.stl)
- [Основание (STL)](/p3/stl/dao_01.stl)
...
- [Сценарий (HTML)](projects/dream/dream.html)
- [Параметрическая модель (SCAD)](projects/dream/dream.scad)
...
- [Презентация (PDF)](projects/safe/safe.pdf)
- [Параметрическая модель (SCAD)](projects/safe/safe.scad)
- [Развертка основания (SVG)](projects/safe/draw/base.svg)
- [Развертка крышки (SVG)](projects/safe/draw/cap.svg)
...
[Установка среды разработки OpenCascade - Python 3.7 - Win64](/p3/docs/setup.html) 
